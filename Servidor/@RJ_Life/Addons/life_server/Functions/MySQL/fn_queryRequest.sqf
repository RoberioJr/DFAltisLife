...
_query = switch (_side) do {
    ...
    case civilian: {format ["SELECT pid, name, cash, bankacc, adminlevel, donorlevel, civ_licenses, arrested, civ_gear, civ_stats, civ_alive, civ_position, playtime, base, exercito FROM players WHERE pid='%1'",_uid];};
