...
//Sets of animations
if ((_vInfo select 1) isEqualTo "civ" && (_vInfo select 2) in ["B_GEN_Van_02_transport_F","B_GEN_Van_02_vehicle_F","B_Truck_01_box_F","B_Truck_01_fuel_F","B_Truck_01_transport_F","B_Truck_01_covered_F","B_MRAP_01_F","B_Quadbike_01_F","O_MRAP_02_F","O_LSV_02_unarmed_F","O_Truck_03_device_F","O_Truck_03_fuel_F","O_Truck_03_transport_F","O_Truck_02_transport_F","O_Truck_02_covered_F","I_MRAP_03_F","C_Van_01_fuel_F","C_Hatchback_01_F","C_Offroad_02_unarmed_F","C_Van_01_box_F","C_Van_01_transport_F","C_Truck_02_fuel_F","C_Van_02_medevac_F","C_Offroad_01_F","C_SUV_01_F","C_Hatchback_01_sport_F"] && !((_vInfo select 8) isEqualTo 13)) then {
    [_vehicle,"civ_littlebird",true] remoteExecCall ["life_fnc_vehicleAnimate",_unit];
};

if ((_vInfo select 1) isEqualTo "cop" && ((_vInfo select 2)) in ["C_Offroad_01_F","B_MRAP_01_F","C_SUV_01_F","C_Hatchback_01_sport_F","B_Heli_Light_01_F","B_Heli_Transport_01_F","O_LSV_02_unarmed_F"]) then {
    [_vehicle,"cop_offroad",true] remoteExecCall ["life_fnc_vehicleAnimate",_unit];
};

if ((_vInfo select 1) isEqualTo "med" && (_vInfo select 2) in ["C_Offroad_01_F","B_MRAP_01_F","C_SUV_01_F","C_Hatchback_01_sport_F","B_Heli_Light_01_F","B_Heli_Transport_01_F","C_Offroad_01_F","C_Van_02_medevac_F","B_Heli_Light_01_F","C_Hatchback_01_sport_F","C_SUV_01_F","B_MRAP_01_F"]) then {
