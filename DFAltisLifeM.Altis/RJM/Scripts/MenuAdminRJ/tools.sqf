_pathtotools = "RJM\Scripts\MenuAdminRJ\tools\";
_pathtoweapon = "RJM\Scripts\MenuAdminRJ\armas\";
_pathtovehicles = "RJM\Scripts\MenuAdminRJ\veh\";
//_pathtosoldier= "RJM\Scripts\MenuAdminRJ\spawn\";
