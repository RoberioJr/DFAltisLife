...
(CONTROL(2800,2803)) ctrlSetStructuredText parseText format[
   ...
   " +(localize "STR_Shop_Veh_UI_SellP")+ " <t color='#8cff9b'>$%2</t><br/> Preço Do Seguro: <t color='#8cff9b'>$%9</t><br/> Estado Do Seguro: %10 <br/>
...
if(_insurance == 1) then {"<t color='#8cff9b'>Assegurado</t>"} else {"<t color='#FF0000'>Sem Seguro</t>"},
