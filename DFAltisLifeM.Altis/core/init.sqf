...
[0, "Esperando O Servidor Estar Pronto."] call mav_introcam_fnc_updateCinematicStatus;
...
[1, "APERTE 'SPACE' PARA CONTINUAR"] call mav_introcam_fnc_updateCinematicStatus;
