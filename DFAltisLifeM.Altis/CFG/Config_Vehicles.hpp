class CarShops {
    ...
    */
	...
	class car_luxo {
		...
		vehicles[] = {
			{ "V12_R34M", "" },
			{ "V12_R34M_ORANGE", "" }, //SkyLine
			{ "V12_R34M_BLEU", "" },
			{ "V12_R34M_GRIS", "" },
			{ "AlessioMustang", "" },
			{ "AlessioMustangChrome", "" }, //Mustang
			{ "AlessioMustangGold", "" },
			{ "CarlosF12", "" }, //Ferrari
			{ "CarlosF12C", "" },
			{ "AlessioAventador", "" },
			{ "AlessioAventadorC", "" }, //Lamborghini
			{ "AlessioAventadorG", "" }
		};
	};
    ...
    class cop_car {
        ...
        vehicles[] = {
			...
			{ "AlessioMustangCOP", "call life_coplevel >= 3" },
...
class LifeCfgVehicles {
    ...
    */
	...
	class FerrariBerlinettaCFG {
		vItemSpace = 30;
		price = 250000;
		textures[] = {};
	};
	
	class LamborghiniCFG {
		vItemSpace = 30;
		price = 350000;
		textures[] = {};
	};
	...
	//Mustang
	class AlessioMustangCOP : MustangCFG {conditions = "";};
	class AlessioMustang : MustangCFG {conditions = "";};
	class AlessioMustangChrome : MustangCFG {conditions = "";};
	class AlessioMustangGold : MustangCFG {conditions = "call life_donorLevel >= 1";};
	//Ferrari Berlinetta
	class CarlosF12 : FerrariBerlinettaCFG {conditions = "";};
	class CarlosF12C : FerrariBerlinettaCFG {conditions = "";};
	//Lamborghini 
	class AlessioAventador : LamborghiniCFG {conditions = "";};
	class AlessioAventadorC : LamborghiniCFG {conditions = "";};
	class AlessioAventadorG : LamborghiniCFG {conditions = "call life_donorLevel >= 1";};
	//SkyLine
	class V12_R34M_ORANGE : SkyLineCFG {conditions = "";};
	class V12_R34M : SkyLineCFG {conditions = "";};
	class V12_R34M_BLEU : SkyLineCFG {conditions = "";};
	class V12_R34M_GRIS : SkyLineCFG {conditions = "";};
	
	//Peugeot
	class Guillaume9545_Peugeot_207 {
        vItemSpace = 55;
		conditions = "";
		price = 45000;
		textures[] = {
			{ "Peugeot - Preto", "civ", {
                "\guillaume9545_peugeot_207\data\couleur\noir.paa"
            }, "" },
			{ "Peugeot - Laranja", "civ", {
                "\guillaume9545_peugeot_207\data\couleur\orange.paa"
            }, "" },
			{ "Peugeot - Branco", "civ", {
                "\guillaume9545_peugeot_207\data\couleur\blanc.paa"
            }, "" },
			{ "Peugeot - Verde", "civ", {
                "\guillaume9545_peugeot_207\data\couleur\vert.paa"
            }, "" },
			{ "Peugeot - Cinza", "civ", {
                "\guillaume9545_peugeot_207\data\couleur\gris.paa"
            }, "" },
			{ "Peugeot - Violeta", "civ", {
                "\guillaume9545_peugeot_207\data\couleur\violet.paa"
            }, "" }
		};
	};
	//*//
