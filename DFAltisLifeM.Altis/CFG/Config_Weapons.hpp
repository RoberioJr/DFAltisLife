...
class WeaponShops {
    ...
    class rebel {
        ...
        items[] = {
			...
			{ "CAG_HK416AFG_D", "", 55000, -1, "" }, //CAG_HK Desert
			{ "CAG_HK416CRS_W", "", 55000, -1, "" }, //CAG_HK Camo
			{ "CAG_HK416CRS_MX", "", 55000, -1, "" }, //CAG_HK Mixada
			{ "CAG_HK416", "", 55000, -1, "" }, //CAG_HK Preta
			...
			{ "hlc_rifle_c1A1", "", 120000, -1, "" }, //Fal Madeira 1
			{ "hlc_rifle_FAL5000_RH", "", 130000, -1, "" }, //Fal Grafit
			{ "hlc_rifle_FAL5061Rail", "", 160000, -1, "" }, //Fal PARA
        ...
        mags[] = {
			...
			{ "hlc_10Rnd_762x51_T_fal", "", 1500, -1, "" }, //Pente Fal 10rnd 7.62
			{ "hlc_50rnd_762x51_M_FAL", "", 2225, -1, "" }, //Pente Fal 50rnd 7.62
    ...
    class cop_basic {
        ...
        items[] = {
			...
			{ "srifle_DMR_06_olive_F", "", 190000, -1, "call life_coplevel >= 5" }, //MK14
			{ "srifle_DMR_03_F", "", 185000, -1, "call life_coplevel >= 5" }, //MKl
			{ "arifle_SPAR_03_blk_F", "", 180000, -1, "call life_coplevel >= 6" } //SPAR-17
        };
        mags[] = {
            { "16Rnd_9x21_Mag", "", 125, -1, "" },
