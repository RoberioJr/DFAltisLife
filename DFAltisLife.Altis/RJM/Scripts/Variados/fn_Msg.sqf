...
*/  
    ...
    _messages = [  
        "Alguma Dúvida? Entre Em Nosso Discord:<br/> <t color='#e32828' size='1.5'>Discord.gg/sEFqb2r</t>", 
        "Nosso Site:<br/><t color='#e32828' size='1.5'>EM BREVE</t>",
        "Horarios De Restart:<br/> <t color='#e32828' size='1.5'>02:00 | 06:00 | 10:00 | 14:00 | 18:00 | 22:00</t>"		
    ];  
