...
switch (playerSide) do {
	case civilian : {
		...
		_Btn1 buttonSetAction "[0] call RJM_fnc_sAssaltoMSG; closeDialog 0;";
		// Botao 2
		...
		_Btn2 buttonSetAction "[1] call RJM_fnc_sAssaltoMSG; closeDialog 0;";
		// Botao 3
		_Btn3 ctrlSetText "Mete o pé";
		_Btn3 ctrlSetTooltip "Mete o pé, vai!";
		_Btn3 buttonSetAction "[2] call RJM_fnc_sAssaltoMSG; closeDialog 0;";
	};
	case west : {
		// Botao 1
