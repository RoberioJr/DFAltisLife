		...
		class Offroad_01_base_F
		{
			...
			class Colors
			{
				...
				class GreenOcean
				{
					...
					displayText = "Verde/Azul Ocean Fade";
					price = 2000;
					texture = "a3\soft_f\offroad_01\data\offroad_01_ext_base03_co.paa";
...
class mav_tuning_dialog_main {
    ...
    class controls {
		...
		{
			idc = -1;
			text = "Loja De Tunagem"; //--- ToDo: Localize;
		...
		{
			idc = 1;
			text = "SAIR DO TUNING SHOP"; //--- ToDo: Localize;
			x = 0.0359375 * safezoneW + safezoneX;
...
class mav_tuning_dialog_rgbcolor {
    ...
    class controls {
		...
		{
			idc = 3;
			text = "APLICAR COR"; //--- ToDo: Localize;
