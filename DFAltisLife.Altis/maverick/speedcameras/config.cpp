...
class Maverick_SpeedCameras {
	...
	SpeedCameras[] = {
	  //{{<position>}, <direction>, <speedlimit>},
        //{{3605.94,13087.6,0}, 283.865, 45}, //Kavalla Martketplace [Altis]
        {{3777.49,13420.8,0}, 146.733, 95},		//Outside kavalla near the construction site [Altis]
		{{14151.61,16529.19,0}, 265.902, 120},
		{{17249.35,13322.70,0}, 231.373, 110},
		{{23337.09,19750.18,0}, 77.870, 125}
	};
	...
	RemoveLicenses[] = {
		...
		{ "Licensa De Motorista" , "license_civ_driver", 15 },     //Remove the driver license if he was diriving faster than allowed by at least 1km/h
		{ "Licensa De Caminhoneiro" , "license_civ_trucking", 25 }, //Remove the trucker license if he was diriving faster than allowed by at least 25km/h
	};
	...
	BankVariable		   = "RJM_BANCO"; //Adjust your bank account variable
	
	class localization {
	
		//Define the messages, which will be shown to the player, when he was driving too fast
		msgSpeedCamera		   = "Radar De Velocidade";
		msgInfo                = "Você Esta Dirigindo A Mais De %1 Km/h!";
		msgRemoveLicense 	   = "Sua %1 Foi Revogada!";
		msgWantedAdd  		   = "Você Foi Adicionado Na Lista De Procurados!";
		msgSpeedingFee         = "Você Pagou %1R$ Por Ultrapassar Os Limites De Velocidade!";
	};
};