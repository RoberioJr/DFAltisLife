class marketDisplay {
    ...
    class controlsBackground {
		...
		{
			idc = -1;
			text = "Distrito Federal - Preço Dos Items"; //--- ToDo: Localize;
		...
		{
			idc = -1;
			text = "Informação Do Item"; //--- ToDo: Localize;
