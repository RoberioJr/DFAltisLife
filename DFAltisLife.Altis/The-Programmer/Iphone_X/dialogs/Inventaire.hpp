...
class The_Programmer_Iphone_Stuff_Menu {
   ...
   class controls
   {
       ...
       class Utiliser : Life_RscButtonInvisible
       {
           idc = -1;
           onbuttonclick = "[0] call life_fnc_useItem;";
       ...
       {
           idc = -1;
           onbuttonclick = "[0] call life_fnc_removeItem;";
           x = 0.7456095 * safezoneW + safezoneX;
           y = 0.699287341199606 * safezoneH + safezoneY;
           w = 0.05 * safezoneW;
           h = 0.03 * safezoneH;
       };
       class Donner : Life_RscButtonInvisible
       {
           idc = -1;
           onbuttonclick = "[0] call life_fnc_giveItem;";
