...
class Clothing {
    class bruce {
        ...
        backpacks[] = {
            ...
            { "B_Bergen_dgtl_f", "", 12000, "" }, //Apex DLC
            { "B_Bergen_tna_f", "", 12000, "" } //Apex DLC
        };
    };
    ...
    class med_clothing {
        ...
        backpacks[] = {
            { "NONE", $STR_C_Remove_backpacks, 0, "" },
            { "B_FieldPack_oli", $STR_C_EMS_backpacks, 2500, "" },
			{ "B_Carryall_cbr", $STR_C_EMS_backpacks, 4500, "" }
        };
    };
    ...
    class reb {
        ...
        uniforms[] = {
            ...
            { "U_I_G_Story_Protagonist_F", "", 1700, "" },
            ...
            { "U_I_C_Soldier_Bandit_3_F", "", 3500, "" }, //Apex DLC
            { "U_I_C_Soldier_Bandit_4_F", "", 3500, "" }, //Apex DLC
            { "U_I_C_Soldier_Bandit_5_F", "", 3500, "" }, //Apex DLC
            { "U_I_C_Soldier_Camo_F", "", 3600, "" }, 
			{ "U_I_CombatUniform_tshirt", "", 5000, "" }, 
			{ "U_I_CombatUniform_shortsleeve", "", 5000, "" }, 
			{ "U_BG_Guerilla1_1", "", 2300, "" }, 
			{ "U_B_CTRG_3", "", 5200, "" }, 
			{ "U_B_CTRG_2", "", 5200, "" }, 
			{ "U_B_CTRG_1", "", 5200, "" } 
        };
        ...
        vests[] = {
            { "NONE", $STR_C_Remove_vests, 0, "" },
            { "V_BandollierB_cbr", "Sem Proteção", 950, "" },
            { "V_HarnessO_brn", "Sem Proteção", 1250, "" },
			{ "V_TacChestrig_grn_F", "Sem Proteção", 1500, "" },
            { "V_TacVest_khk", "Colete NV1", 3200, "" },
			{ "V_TacVest_brn", "Colete NV1", 3200, "" },
			{ "V_TacVest_oli", "Colete NV1", 3200, "" },
			{ "V_TacVest_blk", "Colete NV1", 3200, "" },
