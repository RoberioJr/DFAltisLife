...
class WeaponShops {
    ...
    class gun {
        ...
        items[] = {
			...
			{ "arifle_Katiba_F", "", 120000, -1, "" } //Katiba
        };
        mags[] = {
    ...
    class rebel {
        ...
        items[] = {
			...
			{ "arifle_Mk20_F", "", 40000, -1, "" }, //MK-20
			{ "arifle_CTAR_blk_F", "", 45000, -1, "" }, //CAR
			{ "arifle_SPAR_01_blk_F", "", 50000, -1, "" }, //SPAR-16
            { "arifle_Katiba_F", "", 60000, -1, "" }, //Katiba
			{ "arifle_MXC_F", "", 60000, -1, "" }, //MXC
			{ "arifle_MX_F", "", 70000, -1, "" }, //MX
			{ "arifle_MXM_F", "", 90000, -1, "" }, //MXM
			{ "arifle_MXM_Black_F", "", 90000, -1, "" }, //MXM
			{ "arifle_MX_SW_F", "", 150000, -1, "" }, //MX-SW
			{ "arifle_MX_SW_Black_F", "", 150000, -1, "" }, //MX-SW
			{ "LMG_03_F", "", 160000, -1, "" }, //LIM-85
			{ "LMG_Mk200_F", "", 280000, -1, "" }, //MK200
			{ "LMG_Zafir_F", "", 550000, -1, "" }, //Zafir
			...
			{ "srifle_EBR_F", "", 170000, -1, "" }, //MK18
			{ "srifle_DMR_06_olive_F", "", 190000, -1, "" }, //MK14
			{ "srifle_DMR_03_F", "", 200000, -1, "" }, //MKl
			{ "arifle_SPAR_03_blk_F", "", 220000, -1, "" } //SPAR-17
        };
        mags[] = {
            { "30Rnd_556x45_Stanag_Tracer_Red", "", 475, -1, "" }, //5.56 30rnd TRG, SPAR-16 e MK20
            { "30Rnd_762x39_Mag_Tracer_Green_F", "", 1250, -1, "" }, //7.62 30rnd AK12 e AKM
            { "30Rnd_545x39_Mag_Tracer_Green_F", "", 300, -1, "" }, //5.45 30rnd AKS
            { "30Rnd_65x39_caseless_green_mag_Tracer", "", 525, -1, "" }, //6.5 30rnd Katiba
            { "10Rnd_762x54_Mag", "", 750, -1, "" }, //7.62 10rnd
            { "20Rnd_556x45_UW_mag", "", 225, -1, "" }, //5.56 20rnd
			{ "150Rnd_762x54_Box_Tracer", "", 4750, -1, "" }, //7.62 150rnd Zafir
			{ "200Rnd_65x39_cased_Box_Tracer", "", 4000, -1, "" }, //6.5 200rnd MK200
			{ "200Rnd_556x45_Box_Tracer_Red_F", "", 2750, -1, "" }, //5.56 200rnd LIM-85
			{ "11Rnd_45ACP_Mag", "", 150, -1, "" },
			{ "30Rnd_65x39_caseless_mag_Tracer", "", 525, -1, "" }, //6.5 30rnd MX
			{ "100Rnd_65x39_caseless_mag_Tracer", "", 1750, -1, "" }, //6.5 100rnd mxSW
			{ "20Rnd_762x51_Mag", "", 1750, -1, "" }, //7.62 20rnd sniper
			{ "20Rnd_650x39_Cased_Mag_F", "", 350, -1, "" }, //6.5 20rnd sniper
            { "30Rnd_580x42_Mag_Tracer_F", "", 475, -1, "" } //5.8 30rnd
        };
        accs[] = {
			...
			{ "optic_DMS", "", 10000, -1, "" },
			{ "optic_AMS", "", 15000, -1, "" },
			{ "optic_AMS_snd", "", 15000, -1, "" },
			//{ "optic_LRPS", "", 50000, -1, "" },
			{ "bipod_01_F_blk", "", 7500, -1, "" },
			{ "bipod_02_F_blk", "", 7000, -1, "" }
        };
    };
    ...
    class cop_basic {
        ...
        items[] = {
            ...
            { "hgun_Pistol_heavy_01_F", "", 9500, -1, "" },
			{ "hgun_ACPC2_F", "", 17500, -1, "call life_coplevel >= 3" },
            { "SMG_02_ACO_F", "", 22500, -1, "" },
			{ "arifle_SPAR_01_blk_F", "SPAR-16 5.56mm", 35000, -1, "" }, //SPAR-16
			{ "arifle_Katiba_F", "Katiba 6.5mm", 50000, -1, "" }, //Katiba
            { "arifle_MX_Black_F", "MX Preta 6.5mm", 45000, -1, "call life_coplevel >= 2" },
            { "arifle_MXC_Black_F", "MXC Preta 6.5mm", 35000, -1, "" },
			{ "arifle_MXM_Black_F", "MXM Preta 6.5mm", 60000, -1, "call life_coplevel >= 3" }, //MXM
			{ "srifle_EBR_Hamr_pointer_F", "MK18 EBR 7.62mm", 110000, -1, "call life_coplevel >= 3" },
            { "srifle_DMR_03_F", "MK-l EMR 7.62mm", 140000, -1, "call life_coplevel >= 4" }, //Apex DLC Sniper
			{ "srifle_DMR_06_olive_F", "MK-14 7.62mm", 130000, -1, "call life_coplevel >= 5" }, //MK14
			{ "arifle_SPAR_03_blk_F", "SPAR-17 7.62mm", 150000, -1, "call life_coplevel >= 6" }, //SPAR-17
			{ "arifle_AK12_F", "AK12 7.62mm", 95000, -1, "call life_coplevel >= 3" }, //AK-12
			{ "LMG_03_F", "LIM-85 LMG 5.56mm", 120000, -1, "call life_coplevel >= 2" }, //LIM-85
			{ "arifle_MX_SW_F", "MX-SW LMG 6.5mm", 110000, -1, "call life_coplevel >= 2" }, //MX-SW
			{ "LMG_Mk200_F", "MK200 LMG 6.5mm", 160000, -1, "call life_coplevel >= 4" }, //MK200
			{ "LMG_Zafir_F", "Zafir LMG 7.62mm", 280000, -1, "call life_coplevel >= 6" } //Zafir
        };
        mags[] = {
            { "16Rnd_9x21_Mag", "", 125, -1, "" },
