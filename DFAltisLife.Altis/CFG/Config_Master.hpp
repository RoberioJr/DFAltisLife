...
/* Database Related Settings */
    ...
    saved_virtualItems[] = { "pickaxe","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","apple","peach","guava","peach","grape","strawberry","banana","pineapple","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit" }; //Array of virtual items that can be saved on your player.
...
/* System Settings */
    ...
    escapeMenu_displayText = "Distrito Federal | RJM Scripts"; //Text displayed in the escape menu. Make it short.. around 20 characters.
    ...
    bank_cop = 120000; //Amount of cash in bank for new cops
    bank_civ = 120000; //Amount of cash in bank for new civillians
    bank_med = 120000; //Amount of cash in bank for new medics
