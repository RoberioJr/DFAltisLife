class Socket_Reciever {
    ...
    class SQL_Socket {
        ...
        class syncData {};
        class updatePartialRJ {};
        class updateRequestRJ {};
    };
};
...
class Life_Client_Core {
    ...
    class Functions {
		...
		class signLeft {};			//seta esquerda
		class signRight {};			//seta direita
		class signLeftLamp {};		//seta esquerda ativador
		class signRightLamp {};		//seta direita ativador
    };
