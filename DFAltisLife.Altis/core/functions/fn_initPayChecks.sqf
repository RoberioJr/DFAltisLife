	...
	case west:
	{
		switch(FETCH_CONST(life_coplevel)) do
		{
		 /* Policia Militar */
			...
			case 9: {life_paycheck = life_paycheck + 8000;};
			case 10: {life_paycheck = life_paycheck + 9000;};
			case 11: {life_paycheck = life_paycheck + 10000;};
			case 12: {life_paycheck = life_paycheck + 11000;};
			case 13: {life_paycheck = life_paycheck + 12000;};
		};
