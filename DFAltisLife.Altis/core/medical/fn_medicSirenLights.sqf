...
if !(typeOf _vehicle in ["C_Offroad_01_F","C_Van_02_medevac_F","B_Heli_Light_01_F","C_Hatchback_01_sport_F","C_SUV_01_F","B_MRAP_01_F"]) exitWith {}; //Last chance check to prevent something from defying humanity and creating a monster.
