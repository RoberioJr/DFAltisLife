...
if(life_inv_ziptie < 1) exitWith {hint "Você Precisa De Enforca Gatos!"};
if((animationState cursorobject != "Incapacitated")) exitWith { hint "O Malandro Tem Que Estar No Chão Para Algemar"; };
if((playerSide isEqualTo civilian && {(LIFE_SETTINGS(getNumber,"ziptie_need_rebel") isEqualTo 1)}) && {!license_civ_rebel}) exitwith {hint "Você Precisa Ter Treinamento Rebelde Para Fazer Isso."};
