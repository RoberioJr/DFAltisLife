...
if (!LiberadoRoubarReserva) exitWith { Hint "Não É Possível Assaltar A Reserva No Momento Devido Ela Já Ter Sido Assaltada Recentemente!"; };
[4, 99999] RemoteExec ["RJM_fnc_VarAssaltoPub",2];
