...
_message = "";
_message = _message + "<t align='center' size='6' shadow='0'>Distrito Federal</t><br /><br />";
...
_message = _message + "Thanks for joining and enjoy your stay, <a color='#B000FF'>Distrito Federal</a>AltisLife.<br />";
