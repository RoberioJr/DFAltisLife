_pathtotools = "RJ\Sistemas\Admin\tools\";
_pathtoweapon = "RJ\Sistemas\Admin\armas\";
_pathtovehicles = "RJ\Sistemas\Admin\veh\";
//_pathtosoldier= "RJ\Sistemas\Admin\spawn\";
_EXECscript1 = 'player execVM "'+_pathtotools+'%1"';
_EXECscript3 = 'player execVM "'+_pathtoweapon+'%1"';
_EXECscript5 = 'player execVM "'+_pathtovehicles+'%1"';
//_EXECscript6 = 'player execVM "'+_pathtosoldier+'%1"';

if ((getPlayerUID player) in Administradores) then { //Lista De Admins
	if ((getPlayerUID player) in Administradores) then { //Colocar Aqui Tambem A Lista De Admins
		adminmenu =
		[
			["RoberioJr Menu",true],
